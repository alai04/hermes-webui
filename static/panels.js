...
const APP_TITLEBAR_KEYS = {
  ...
  profiles: 'tab_profiles', todos: 'tab_todos', insights: 'tab_insights', logs: 'tab_logs', portfolio: 'tab_portfolio', settings: 'tab_settings',
};
const MAIN_VIEW_PANELS = ['settings','skills','memory','tasks','kanban','workspaces','profiles','insights','logs','portfolio','plugin'];
...
async function switchPanel(name, opts = {}) {
  ...
  if (nextPanel === 'portfolio') await loadPortfolio();
